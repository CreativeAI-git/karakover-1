...
<form class="form-horizontal" method="post"  action="<?php if(!empty($cat)){ echo site_url('admin/edit_genrecategory/'.$this->uri->segment(3));}else{
        ...
        <h3 class="text-center gl_heading_black"><?= $title; ?></h3><br>
         ...
         <div class="form-group gl_text_black">
          ...
          <div class="col-sm-8">
            ...
            <input type="text" name="genre_type"  class="form-control"  placeholder="category  name" 

            value="<?php if(!empty($cat)){ echo $cat['genre_type']; } ?>"

            > 

        

         <p><?php echo form_error('genre_type', '<span class="error_msg">', '</span>'); ?></p> 
        ...
        <div class="form-group gl_text_black">
                  ...
                  <div class="col-sm-8" id="admin_profile">
                    ...
                    <?php if(!empty($cat)){ ?>
                      <br/>
                      <br/> <img class="img-responsive" src="<?php echo base_url('assets/genre/'.$cat['image']); ?>" height="250px" width="200" id="blah">
                      <?php }else{ ?>
                     <br/>
