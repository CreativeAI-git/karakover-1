    ...
    <form class="form-horizontal" method="post" action="<?php if(!empty($terms)){ echo base_url('admin/termServices');}else{
      ...
      <fieldset>
        ...
        <div class="form-group" id="main">
          <textarea class="form-control ckeditor" id="terms_page" rows="20" name="editor" required><?php echo $terms['info']; ?></textarea>
        </div>
...
<script>
    ...
    ClassicEditor.create(document.querySelector('#terms_page'), {
        plugins: [
            Essentials,
            Paragraph,
            Heading,
