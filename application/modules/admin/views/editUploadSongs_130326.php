            ...
            <div class="gl_main_creator_form pt-0">
                ...
                <div class="gl_upload_music_bg" <?php if ($songs['zone_type'] >= 1) { ?>
                    ...
                    <div class="gl_upload_music_div">
                        ...
                        <div class="solo_file" id="solofiles" <?php if ($songs['zone_type'] == 5 || $songs['zone_type'] == 3) { ?>
                            style="display: block;"
                            <?php } else { ?>
                            style="display: none;"
                            <?php } ?>>
                        ...
                        <div class="backing_track_files" id="backingtrackguitarfiles" <?php if ($songs['zone_type'] == 3) { ?>
                            style="display: block;"
                            <?php } else { ?>
                            style="display: none;"
                            <?php } ?>>
                        ...
                        <div class="backing_track_files" id="backingtrackbassfiles" <?php if ($songs['zone_type'] == 1) { ?>
                            style="display: block;"
                            <?php } else { ?>
                            style="display: none;"
                            <?php } ?>>
                        ...
                        <div class="backing_track_files" id="backingtrackdrumsfiles" <?php if ($songs['zone_type'] == 2) { ?>
                            style="display: block;"
                            <?php } else { ?>
                            style="display: none;"
                            <?php } ?>>
                        ...
                        <div class="backing_track_files" id="backingtrackkeysfiles" <?php if ($songs['zone_type'] == 4) { ?>
                            style="display: block;"
                            <?php } else { ?>
                            style="display: none;"
                            <?php } ?>>
