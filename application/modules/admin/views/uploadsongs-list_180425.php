               ...
               <div class=" col-md-9 ct_track_form_div mb-4">
                  <table class="table gl_heading_black">
                    ...
                    <div class="gl_heading_black mt-3 ">
                        <h5>Upload Multiple Images(Optional)</h5>
                        <table class="table gl_heading_black">
                            <tr>
                            ...
                            <tr>
                                <td>bass images upload
                                    <input type="file" name="bass_images[]" id="bass_images" multiple>
                                    <span class="error_msg  bass_images"></span>
                                </td>
                                <td>drum images upload
                                    <input type="file" name="drum_images[]" id="drum_images" multiple>
                                    <span class="error_msg  drum_images"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>guitar images upload
                                    <input type="file" name="guitar_images[]" id="guitar_images" multiple>
                                    <span class="error_msg  guitar_images"></span>
                                </td>
                                <td>keyboard images upload
                                    <input type="file" name="keyboard_images[]" id="keyboard_images" multiple>
