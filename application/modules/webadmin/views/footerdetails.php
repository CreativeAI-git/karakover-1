    ...
    <form class="form-horizontal" action="<?php if(!empty($footer[0])){ echo site_url('webadmin/footer_edit/'.$this->uri->segment(3)); }else{ echo  base_url('webadmin/footer_add/'.$this->uri->segment(3));} ?>" method="post"  enctype="multipart/form-data" >
      ...
      <fieldset>
        ...
        <div class="form-group" id="main">
          <textarea class="form-control ckeditor" id="footer_address" rows="20" name="address" ><?php if(!empty($footer[0])){ echo $footer[0]['address']; } ?></textarea>
          <p><?php echo form_error('address', '<span class="error_msg">', '</span>'); ?></p> 
        </div>
        <div class="form-group" id="main">
          <textarea class="form-control ckeditor" id="footer_details" rows="20" name="details" ><?php if(!empty($footer[0])){ echo $footer[0]['details']; } ?></textarea>
...
<script>
    ...
    ['#footer_address', '#footer_details'].forEach(selector => {
