...
<div class="col-sm-12"> 
   <div class="container">
    ...
    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php if(!empty($home[0])){ echo base_url('webadmin/home_edit');}else{
          echo  base_url('webadmin/home_edit');
        } ?>" >
      <fieldset>
        <h1 class="h3 mb-3 page-title"><?= $title; ?></h1>
        <div class="form-group" id="main">
          <textarea class="form-control ckeditor" id="homepage_details" rows="20" name="details" required><?php echo $home[0]['details']; ?></textarea>
        ...
        <div class="form-group gl_text_black">
          ...
          <div class="col-sm-8" id="image-preview-container">
              ...
              <div id="image-preview">
                ...
                <img class="img-responsive" src="<?php echo base_url('/assets/website/home/'.$home[0]['image']); ?>" height="250px" width="200px">
                <?php } ?>
              </div>
...
<script>
    ...
    ClassicEditor.create(document.querySelector('#homepage_details'), {
        plugins: [
            Essentials,
            Paragraph,
            Heading,
